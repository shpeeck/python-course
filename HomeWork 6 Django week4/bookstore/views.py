...
from .models import Books, Autors, Comments
    ...
    try:
        ...
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                new_form.book = book
                new_form.save()
        return render(request, 'bookstore/book.html', context={'book': book, 'autor': autor, 'comments': comments, 'post_form': CommentForm})
